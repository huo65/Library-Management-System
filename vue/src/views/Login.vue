    ...
    <el-form ref="form" :model="form" :rules="rules" class="login-page">
      ...
      <el-form-item>
        <div style="display: flex">
          <el-input v-model="form.validCode" style="width: 45%;" placeholder="Verification code"></el-input>
      ...
      <el-form-item>
        ...
        <el-button type="text" style="font-size: 16px;margin-left: 120px" @click="$router.push('/register')">New to LMS?
          Sign up
        </el-button>
      </el-form-item>
    </el-form>
